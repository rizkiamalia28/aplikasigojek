	...
	<nav class="navbar-top navbar-default" role="navigation">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li>
					<a href="#" id="">
						<span class="glyphicon glyphicon-evelope"></span>
					NOtification</a>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span>
						Profile<strong class=""caret></strong>
					</a>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						Setting<strong class="caet"></strong>
					</a>
					<ul class="dropdown-menu">
						<li>
							<a href="#" id="suNav">
						...
						<div class="tabbable" id="tabs-662392">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="panelInfoLok">
									<p id="">
										<b>INfo Lokasi Mobil, Posisi Anda Yang Paling Bawah</b>
									</p>
								...
								<div class="tab-pane" id="panelInfoUser"><br/>
									<input type="text" class="form-control" id="userPengguna" value="<?php echo $idPengguna; ?>" readOnly/></div>
							</div>
						</div>
					</div>
					<div class="col-md-2 jarak Tombol">
...
<div class="modal fade" id="pesananDialog" 
role="dialog" aria-labelledby="myModalLabel"
aria-hidden="true" data backdrop="static" data-
keyboard="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
	...
	<script src="https://maps.goggleapis.com/
	maps/api/js?signed_in=true"></script>
